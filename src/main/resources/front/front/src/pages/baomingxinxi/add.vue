    ...
    >
          ...
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}' label="学费" prop="xuefei">
            <el-input v-model.number="ruleForm.xuefei" 
                placeholder="学费" clearable :disabled=" false  ||ro.xuefei"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"50%","padding":"10px","margin":"0 0 10px","background":"#fff"}'  label="驾照类型" prop="jiazhaoleixing">
            <el-select v-model="ruleForm.jiazhaoleixing" placeholder="请选择驾照类型" :disabled=" false  ||ro.jiazhaoleixing" >
              <el-option
